...
export const uploadImage = async (fileBuffer, folder = 'images', userId = null, originalName = 'image') => {
  try {
    ...
    console.log('[uploadImage] Start upload:', {
      bucket: bucket.name,
      fileName,
    ...
    console.log('[uploadImage] Upload complete:', { publicUrl: downloadURL });
...
export const uploadMultipleImages = async (files, folder = 'images', userId = null) => {
  try {
    ...
    console.log('[uploadMultipleImages] Files count:', files.length);
...
export const deleteImage = async (fileName) => {
  try {
    ...
    console.log('[deleteImage] Deleting:', { bucket: bucket.name, fileName });
